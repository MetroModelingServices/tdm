...
if (mce) {
  omxFileName <- paste(project.dir,"/_mceInputs/",project,"_",year,"_",alternative,"_dest_choice_nhw.omx",sep='')
...
#  write.table(ma.nhwpu, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.nhwpu.csv", col.names=c("nhwpu"))
}
