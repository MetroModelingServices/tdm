...
#  write.table(ma.hbwldcls, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.hbwldcls.csv", col.names=c("hbwldcls"))
#  write.table(ma.hbwprl, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.hbwprl.csv", col.names=c("hbwprl"))
}
...
#  write.table(ma.hbwmdcls, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.hbwmdcls.csv", col.names=c("hbwmdcls"))
#  write.table(ma.hbwprm, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.hbwprm.csv", col.names=c("hbwprm"))
}
...
#  write.table(ma.hbwhdcls, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.hbwhdcls.csv", col.names=c("hbwhdcls"))
#  write.table(ma.hbwprh, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.hbwprh.csv", col.names=c("hbwprh"))
}
