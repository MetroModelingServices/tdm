...
if (mce) {
  omxFileName <- paste(project.dir,"/_mceInputs/",project,"_",year,"_",alternative,"_dest_choice_nhnw.omx",sep='')
...
#  write.table(ma.nhnwpu, sep=",", row.names=F, file="../_mceInputs/nonskims/ma.nhnwpu.csv", col.names=c("nhnwpu"))
}
