...
### write mce cval file
if (mce) {
  omxFileName <- paste(project.dir,"/_mceInputs/",project,"_",year,"_",alternative,"_cval.omx",sep='')
  create_omx(omxFileName, numzones, ncol(mf.cval), 7)
...
#  write.table(mf.cval, sep=",", row.names=F, file="../_mceInputs/nonskims/mf.cval.csv")
}
