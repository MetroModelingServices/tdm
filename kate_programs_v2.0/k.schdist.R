...
if (mce) {
  ...
  omxFileName <- paste(project.dir,"/_mceInputs/",project,"_",year,"_",alternative,"_dest_choice_sch.omx",sep='')
...
distsum ("mf.schdt", "School Distribution", "ga", 3, "schdist", project, initials)
